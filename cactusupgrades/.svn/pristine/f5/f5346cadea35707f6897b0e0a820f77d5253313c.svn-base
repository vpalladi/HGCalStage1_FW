...
COPY xilinx_gth_16b_5g_cpll_exdes.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\xilinx_gth_16b_5g_cpll_exdes.ucf -p xc7vx690t-ffg1927-2 xilinx_gth_16b_5g_cpll_exdes.ngc xilinx_gth_16b_5g_cpll_exdes.ngd
...
ECHO 'Running NGD'
map -register_duplication on -logic_opt on -timing -ol high -p xc7vx690t-ffg1927-2 -o mapped.ncd xilinx_gth_16b_5g_cpll_exdes.ngd
...
netgen -ofmt verilog -sim -sdf_path ../../implement/results -dir . -tm xilinx_gth_16b_5g_cpll_exdes -w routed.ncd routed.v
