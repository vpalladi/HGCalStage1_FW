...
void usage ( void )
{
  ...
  fprintf ( stderr, "      fsck               -- In-depth analysis of file system\n" );
   fprintf ( stderr, "      swap               -- Byte swap an image (expert use only!)\n" );
  fprintf ( stderr, "\n" );
}
...
int do_fsck( int argc, char** argv )
{
  if ( argc != 3 )
  {
    return -1;
