...
U8 SDR12[] = SENSOR_REC ( 12, 21, SENSOR_TYPE_VOLTAGE, 1, 0, 18, 0xF0,0x7F,
...
U8 SDR18[] = SENSOR_REC ( 18, 20, SENSOR_TYPE_VOLTAGE, 1, 0, 15, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 6, '+','1','.','5',' ','V' );
U8 SDR19[] = SENSOR_REC ( 19, 36, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS, 6, '+','1','.','5',' ','I' );
U8 SDR20[] = SENSOR_REC ( 20, 12, SENSOR_TYPE_VOLTAGE, 1, 0, 10, 0xF0, 0x7F,
...
U8 SDR24[] = SENSOR_REC ( 18, 23, SENSOR_TYPE_VOLTAGE, 1, 0, 10, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 10, '+','1','.','0',' ','V',' ','G','T','X' );
U8 SDR25[] = SENSOR_REC ( 19, 39, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS, 10, '+','1','.','0',' ','I',' ','G','T','X' );
U8 SDR26[] = SENSOR_REC ( 20, 15, SENSOR_TYPE_VOLTAGE, 1, 0, 12, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 10, '+','1','.','2',' ','V',' ','G','T','X' );
U8 SDR27[] = SENSOR_REC ( 21, 31, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS, 10, '+','1','.','2',' ','I',' ','G','T','X' );
U8 SDR28[] = SENSOR_REC ( 22, 17, SENSOR_TYPE_VOLTAGE, 1, 0, 25, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 7, 'L','8',' ','V','A','D','J' );
U8 SDR29[] = SENSOR_REC ( 23, 33, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
