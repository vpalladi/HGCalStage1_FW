...
package ipbus_decode_mp7xe_infra is

  constant IPBUS_SEL_WIDTH: positive := 5; -- Should be enough for now?
  subtype ipbus_sel_t is std_logic_vector(IPBUS_SEL_WIDTH - 1 downto 0);
  function ipbus_sel_mp7xe_infra(addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t;

-- START automatically  generated VHDL the Fri Aug 26 12:25:12 2016 
...
end ipbus_decode_mp7xe_infra;

package body ipbus_decode_mp7xe_infra is

  function ipbus_sel_mp7xe_infra(addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t is
...
-- END automatically generated VHDL
  ...
  end function ipbus_sel_mp7xe_infra;
