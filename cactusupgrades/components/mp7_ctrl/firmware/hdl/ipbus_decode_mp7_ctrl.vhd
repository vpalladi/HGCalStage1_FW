...
-- START automatically  generated VHDL the Wed Mar 16 18:33:20 2016 
  ...
  constant N_SLV_BOARD_ID: integer := 2;
...
-- START automatically  generated VHDL the Wed Mar 16 18:33:20 2016 
    if    std_match(addr, "----------------------------0---") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_ID, IPBUS_SEL_WIDTH)); -- id / base 0x00000000 / mask 0x00000008
    elsif std_match(addr, "----------------------------1-0-") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_CSR, IPBUS_SEL_WIDTH)); -- csr / base 0x00000008 / mask 0x0000000a
    elsif std_match(addr, "----------------------------1-1-") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_BOARD_ID, IPBUS_SEL_WIDTH)); -- board_id / base 0x0000000a / mask 0x0000000a
-- END automatically generated VHDL
