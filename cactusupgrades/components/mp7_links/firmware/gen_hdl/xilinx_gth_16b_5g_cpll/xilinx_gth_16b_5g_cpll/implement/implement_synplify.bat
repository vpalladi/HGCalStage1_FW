...
COPY xilinx_gth_16b_5g_cpll_exdes.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\xilinx_gth_16b_5g_cpll_exdes.ucf -p xc7vx690t-ffg1927-2 xilinx_gth_16b_5g_cpll_exdes.edf xilinx_gth_16b_5g_cpll_exdes.ngd
...
ECHO 'Running NGD'
map -p xc7vx690t-ffg1927-2 -o mapped.ncd xilinx_gth_16b_5g_cpll_exdes.ngd
