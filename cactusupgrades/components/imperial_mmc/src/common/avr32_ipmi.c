...
void ipmi_data_process ( U8* pData, U8 pLen )
{
  ...
  switch ( xMsgHeader->netfun >> 2 )
  {
    ...
    case IPMI_CONTROLLER_SPECIFIC:
      ...
      switch ( xMsgHeader->cmdType )
      {
        case IPMI_OEM_NULL:
          ...
          break;
        case IPMI_OEM_COMMIT:
          xDataFunction = &oem_cmd_commit;
          break;
        case IPMI_OEM_SETMAC:
          xDataFunction = &oem_cmd_setmac;
          break;
        case IPMI_OEM_SETIP:
          xDataFunction = &oem_cmd_setip;
          break;
        case IPMI_CMD_OEM_SETCURROFFSET:
		  xDataFunction = &oem_cmd_setcurroffset;
		  break;
        case IPMI_OEM_SETRARP:
          xDataFunction = &oem_cmd_setrarp;
          break;
        case IPMI_OEM_NETENABLE:
          xDataFunction = &oem_cmd_netenable;
          break;
        case IPMI_OEM_GETNETINFO:
          xDataFunction = &oem_cmd_netinfo;
          break;
        case IPMI_OEM_HARDRESET:
          xDataFunction = &oem_cmd_hardreset;
          break;
        case IPMI_OEM_HOTSWAPRESET:
          xDataFunction = &oem_cmd_hotswapreset;
          break;
        case IPMI_OEM_FPGARESET:
          xDataFunction = &oem_cmd_fpgareset;
          break;
        default:
    ...
    case IPMI_CMS_NETFN:
      ...
      // CMS-wide standardized commands
      switch ( xMsgHeader->cmdType )
      {
        case IPMI_CMS_GETMAC:
          xDataFunction = &oem_cmd_getmacaddress;
          break;
	case IPMI_CMS_GETIP:
	  xDataFunction = &oem_cmd_getipaddress;
	  break;
	case IPMI_CMS_SETIP:
	  xDataFunction = &oem_cmd_setipaddress;
	  break;
        default:
          dprintf ( "ERROR: Unknown CMS Command!\n" );
          break;
      }
      break;
    default:
