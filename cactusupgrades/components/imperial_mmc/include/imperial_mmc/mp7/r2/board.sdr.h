...
// C and S are packed...
#define SENSOR_REC(SDR_NUM, SENS_NUM, SENS_TYPE, M, UB, B, SC, UPPER_NR, SENS_UNIT, TEXT_LEN, ...) \
{                                                                                        \
	...
	UPPER_NR,		/* Upper non-recoverable Threshold */                                \
...
U8 SDR3[] =
{
  ...
  0x07,			/* Analogue characteristics flags */
  /*32*/
  0x32,			/* Nominal reading (50 - h32) */
  0x4B,			/* Normal maximum (75 - h4B) */
  0x0A,			/* Normal minimum (10 - h0a) */
  0x64,			/* Sensor Maximum reading (100 - h64) */
  0x00,			/* Sensor Minimum reading (0) */
  0x4B,			/* Upper non-recoverable Threshold (75 - h4b) */
  0x37,			/* Upper critical Threshold (55 - h37) */
  0x32,			/* Upper non critical Threshold (50 - h32) */
  /*40*/
  0x00,			/* Lower non-recoverable Threshold (0) */
  0x00,			/* Lower critical Threshold (0) */
  0x00,			/* Lower non-critical Threshold (0) */
...
U8  SDR4[] = SENSOR_REC ( 4, 16, SENSOR_TYPE_VOLTAGE, 1, 0, 10, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  6, '+','1','.','0',' ','V' );
U8  SDR5[] = SENSOR_REC ( 5, 32, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS,  6, '+','1','.','0',' ','I' );
U8  SDR6[] = SENSOR_REC ( 6, 11, SENSOR_TYPE_VOLTAGE, 1, 0, 15, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  6, '+','1','.','5',' ','V' );
U8  SDR7[] = SENSOR_REC ( 7, 27, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS,  6, '+','1','.','5',' ','I' );
U8  SDR8[] = SENSOR_REC ( 8, 19, SENSOR_TYPE_VOLTAGE, 1, 0, 18, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  6, '+','1','.','8',' ','V' );
U8  SDR9[] = SENSOR_REC ( 9, 35, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS,  6, '+','1','.','8',' ','I' );
U8 SDR10[] = SENSOR_REC ( 10, 13, SENSOR_TYPE_VOLTAGE, 1, 0, 25, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  6, '+','2','.','5',' ','V' );
U8 SDR11[] = SENSOR_REC ( 11, 29, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS,  6, '+','2','.','5',' ','I' );
U8 SDR12[] = SENSOR_REC ( 12, 21, SENSOR_TYPE_VOLTAGE, 1, 0, 33, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  6, '+','3','.','3',' ','V' );
U8 SDR13[] = SENSOR_REC ( 13, 37, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS,  6, '+','3','.','3',' ','I' );
U8 SDR14[] = SENSOR_REC ( 14, 22, SENSOR_TYPE_VOLTAGE, 1, 0, 33, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  8, 'M','P','+','3','.','3',' ','V' );
U8 SDR15[] = SENSOR_REC ( 15, 38, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS,  8, 'M','P','+','3','.','3',' ','I' );
U8 SDR16[] = SENSOR_REC ( 16, 14, SENSOR_TYPE_VOLTAGE, 1, 0, 120, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  5, '+','1','2',' ','V' );
U8 SDR17[] = SENSOR_REC ( 17, 30, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS,  5, '+','1','2',' ','I' );
U8 SDR18[] = SENSOR_REC ( 18, 20, SENSOR_TYPE_VOLTAGE, 1, 0, 10, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 12, '+','1','.','0',' ','V',' ','G','T','X',' ','T' );
U8 SDR19[] = SENSOR_REC ( 19, 36, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS, 12, '+','1','.','0',' ','I',' ','G','T','X',' ','T' );
U8 SDR20[] = SENSOR_REC ( 20, 12, SENSOR_TYPE_VOLTAGE, 1, 0, 12, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 12, '+','1','.','2',' ','V',' ','G','T','X',' ','T' );
U8 SDR21[] = SENSOR_REC ( 21, 28, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS, 12, '+','1','.','2',' ','I',' ','G','T','X',' ','T' );
U8 SDR22[] = SENSOR_REC ( 22, 18, SENSOR_TYPE_VOLTAGE, 1, 0, 18, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 12, '+','1','.','8',' ','V',' ','G','T','X',' ','T' );
U8 SDR23[] = SENSOR_REC ( 23, 34, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS, 12, '+','1','.','8',' ','I',' ','G','T','X',' ','T' );
U8 SDR24[] = SENSOR_REC ( 24, 23, SENSOR_TYPE_VOLTAGE, 1, 0, 10, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 12, '+','1','.','0',' ','V',' ','G','T','X',' ','B' );
U8 SDR25[] = SENSOR_REC ( 25, 39, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS, 12, '+','1','.','0',' ','I',' ','G','T','X',' ','B' );
U8 SDR26[] = SENSOR_REC ( 26, 15, SENSOR_TYPE_VOLTAGE, 1, 0, 12, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 12, '+','1','.','2',' ','V',' ','G','T','X',' ','B' );
U8 SDR27[] = SENSOR_REC ( 27, 31, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS, 12, '+','1','.','2',' ','I',' ','G','T','X',' ','B' );
U8 SDR28[] = SENSOR_REC ( 28, 17, SENSOR_TYPE_VOLTAGE, 1, 0, 18, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 12, '+','1','.','8',' ','V',' ','G','T','X',' ','B' );
U8 SDR29[] = SENSOR_REC ( 29, 33, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS, 12, '+','1','.','8',' ','I',' ','G','T','X',' ','B' );
U8 SDR30[] = SENSOR_REC ( 30, 43, SENSOR_TYPE_VOLTAGE, 1, 0, 0, 0x00, 0x7F,
...
int SDR_RECORDS = (sizeof(SDRs) / sizeof(U8 *));
