...
U8 SDR3[] =
{
  ...
  0x64,                 /* Upper non critical Threshold (100) */
  /*40*/
  0x50,                 /* Upper non-recoverable Threshold (h50 - 80) */ 
  0x50,                 /* Upper critical Threshold (h50 - 80) */ 
  0x37,                 /* Upper non critical Threshold (h37 - 55) */ 
  0x02,                 /* positive going Threshold hysteresis value */
  0x02,                 /* negative going Threshold hysteresis value */
  0x00,                 /* reserved */
  0x00,                 /* reserved */
...
U8  SDR4[] = SENSOR_REC ( 4, 15, SENSOR_TYPE_VOLTAGE, 1, 0, 33, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  6, '+','3','.','3',' ','V' );
U8  SDR5[] = SENSOR_REC ( 5, 31, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
...
U8  SDR8[] = SENSOR_REC ( 8, 24, SENSOR_TYPE_VOLTAGE, 1, 0, 25, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  8, 'L','1','2',' ','V','A','D','J' );
U8  SDR9[] = SENSOR_REC ( 9, 40, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS,  8, 'L','1','2',' ','I','A','D','J' );
U8 SDR10[] = SENSOR_REC ( 10, 23, SENSOR_TYPE_VOLTAGE, 1, 0, 25, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  6, '+','2','.','5',' ','V' );
U8 SDR11[] = SENSOR_REC ( 11, 39, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS,  6, '+','2','.','5',' ','I' );
U8 SDR12[] = SENSOR_REC ( 12, 19, SENSOR_TYPE_VOLTAGE, 1, 0, 18, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  6, '+','1','.','8',' ','V' );
U8 SDR13[] = SENSOR_REC ( 13, 35, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS,  6, '+','1','.','8',' ','I' );
U8 SDR14[] = SENSOR_REC ( 14, 21, SENSOR_TYPE_VOLTAGE, 1, 0, 33, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  8, 'M','P','+','3','.','3',' ','V' );
U8 SDR15[] = SENSOR_REC ( 15, 37, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS,  8, 'M','P','+','3','.','3',' ','I' );
U8 SDR16[] = SENSOR_REC ( 16, 13, SENSOR_TYPE_VOLTAGE, 1, 0, 120, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS,  5, '+','1','2',' ','V' );
U8 SDR17[] = SENSOR_REC ( 17, 29, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
...
U8 SDR22[] = SENSOR_REC ( 22, 17, SENSOR_TYPE_VOLTAGE, 1, 0, 18, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 10, '+','1','.','8',' ','V',' ','G','T','X' );
U8 SDR23[] = SENSOR_REC ( 23, 33, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS, 10, '+','1','.','8',' ','I',' ','G','T','X' );
U8 SDR24[] = SENSOR_REC ( 18, 22, SENSOR_TYPE_VOLTAGE, 1, 0, 10, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 10, '+','1','.','0',' ','V',' ','G','T','X' );
U8 SDR25[] = SENSOR_REC ( 19, 38, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS, 10, '+','1','.','0',' ','I',' ','G','T','X' );
U8 SDR26[] = SENSOR_REC ( 20, 14, SENSOR_TYPE_VOLTAGE, 1, 0, 12, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 10, '+','1','.','2',' ','V',' ','G','T','X' );
U8 SDR27[] = SENSOR_REC ( 21, 30, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
                          SENSOR_UNIT_AMPS, 10, '+','1','.','2',' ','I',' ','G','T','X' );
U8 SDR28[] = SENSOR_REC ( 22, 16, SENSOR_TYPE_VOLTAGE, 1, 0, 25, 0xF0, 0x7F,
                          SENSOR_UNIT_VOLTS, 7, 'L','8',' ','V','A','D','J' );
U8 SDR29[] = SENSOR_REC ( 23, 32, SENSOR_TYPE_CURRENT, 1, 0, 0, 0xF0, 0x7F,
